# Case 4 — ruby_llm backend request.
#
...
# ActiveHarness request — streaming, lifecycle hooks, fallback chain all work.
class SupportRubyLLMRequest < ActiveHarness::Request
  ...
  # Lifecycle hooks — side-effects only; event_stream is auto-fired by Request#fire.
  on(:setup) do
